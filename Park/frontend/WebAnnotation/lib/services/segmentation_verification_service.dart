...
class SegmentationVerificationService extends SegmentationService {
  ...
  Future<bool> query() async {
    ...
    if(langService.isEng){
      url = AppService.SERVER_URL + "/user/verificationen/query";
    } else{
      url = AppService.SERVER_URL + "/user/verification/query";
    }
  ...
  Future<bool> submitVerification(var userData, Word segmentation) async {
    ...
    if(langService.isEng){
      url = AppService.SERVER_URL + "/user/verificationen/submit";
    } else{
      url = AppService.SERVER_URL + "/user/verification/submit";
    }
