...
# create model
dictionary = celex.CelexDictionary_en()

# parse lemma file
print("--- parsing celex2 lemmas (eol) ---")
dictionary.parse_lemmas(MAX_LINES_LEMMAS, STEP_SIZE)

# parse word list
print("--- parsing celex2 word list (epw, eow) ---")
dictionary.parse_words(MAX_LINES_WORDLIST, STEP_SIZE)

# write to SQLite database
writeSQLite.write_sqlite_en(dictionary, STEP_SIZE)
